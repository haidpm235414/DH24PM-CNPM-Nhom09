...
| :--- | :--- | :--- | :--- | :--- |
| 1 | **Thái Hoàng Minh** | Team Lead | Chịu trách nhiệm quản lý backlog, làm cầu nối trao đổi với Giảng viên và các nhóm khác, điều phối tiến độ công việc và phân chia task trong Sprint. | [Email](mailto:a@example.com) / [Frontend](./Frontend) |
